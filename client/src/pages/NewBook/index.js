...
function NewBook() {
  ...
  const [createBookAndAuthors, { error: mutationError }] = useMutation(CreateBookAndAuthors, {
        ...
        <form onSubmit={submitBook}>
          ...
          <Select 
            ...
            options={[
              ...
              { text: "Comic Book / Graphic Novel", value: "COMIC_GRAPHIC_NOVEL" },
              { text: "Detective / Mystery", value: "DETECTIVE_MYSTERY" },
